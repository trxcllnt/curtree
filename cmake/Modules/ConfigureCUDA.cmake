...
set(${PROJECT_NAME}_CMAKE_BUILD_FOR_ALL_CUDA_ARCHS FALSE)
set(${PROJECT_NAME}_CMAKE_BUILD_FOR_DETECTED_ARCHS FALSE)

if(DEFINED ENV{CUDAARCHS})
    if("$ENV{CUDAARCHS}" STREQUAL "")
        # If CUDAARCHS is <empty_string>, auto-detect current GPU arch
        set(${PROJECT_NAME}_CMAKE_BUILD_FOR_DETECTED_ARCHS TRUE)
    ...
    elseif("$ENV{CUDAARCHS}" STREQUAL "ALL")
        ...
        set(${PROJECT_NAME}_CMAKE_BUILD_FOR_ALL_CUDA_ARCHS TRUE)
...
if(${PROJECT_NAME}_CMAKE_BUILD_FOR_ALL_CUDA_ARCHS)
...
elseif(${PROJECT_NAME}_CMAKE_BUILD_FOR_DETECTED_ARCHS)
...
message(STATUS "BUILD_FOR_DETECTED_ARCHS: ${${PROJECT_NAME}_CMAKE_BUILD_FOR_DETECTED_ARCHS}")
message(STATUS "BUILD_FOR_ALL_CUDA_ARCHS: ${${PROJECT_NAME}_CMAKE_BUILD_FOR_ALL_CUDA_ARCHS}")
...
list(APPEND ${PROJECT_NAME}_CMAKE_CUDA_FLAGS -Werror=cross-execution-space-call)
list(APPEND ${PROJECT_NAME}_CMAKE_CUDA_FLAGS --expt-extended-lambda --expt-relaxed-constexpr)
list(APPEND ${PROJECT_NAME}_CMAKE_CUDA_FLAGS -Xcompiler=-Wall,-Werror,-Wno-error=deprecated-declarations)
